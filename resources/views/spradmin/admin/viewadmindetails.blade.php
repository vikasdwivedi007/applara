...
@section('content') 
<br>
   <h3>Admin View Details</h3>
      <div class="text-right">
           <a href="{{ route('spr-admin/showAdminData') }}" class="btn btn-success "><i class="fa fa-arrow-left" aria-hidden="true"></i>Go to Back Page</a>
      </div>
      <br>
     <table  id="example" class="table table-striped table-bordered" style="width:100%">
     	   ...
     	   <tr>
     	   	    <th>User Type</th>
     	   	    <td>
                     @if($getSingle->roll_id == 2)
                     <button type="button" title="Admin" class="btn btn-custon-rounded-three btn-info btn-xs"> </i>Admin</button>
                     @endif
                   </td>
     	   </tr>
             <tr>
