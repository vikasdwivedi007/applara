...
@section('content') 
<br>
   <h3>User View Details</h3>
      <div class="text-right">
           <a href="{{ route('spr-admin/showUserlist') }}" class="btn btn-success "><i class="fa fa-arrow-left" aria-hidden="true"></i>Go to Back Page</a>
      </div>
      <br>
     <table  id="example" class="table table-striped table-bordered" style="width:100%">
     	   ...
     	   <tr>
     	   	    <th>User Type</th>
     	   	    <td>
                     @if($getSingle->roll_id == 3)
                     <button type="button" title="User" title="user" class="btn btn-custon-rounded-three btn-info btn-xs"> </i>User</button>
                     @endif
                   </td>
     	   </tr>
             <tr>
